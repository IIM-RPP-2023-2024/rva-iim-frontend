...
import { StavkaPorudzbineDialogComponent } from 'src/app/dialogs/stavka-porduzbine-dialog/stavka-porudzbine-dialog.component';
...
export class StavkaPorudzbineComponent implements OnChanges {
  ...
  public loadData(){
    this.subscription = this.stavkaPorudzbineService.getStavkaByPorudzbina(this.childSelectedPorudzbina.id).subscribe(
